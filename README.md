...
**[→ Setup wizard](https://social-pipeline-installer.alex-425.workers.dev)** — guided step-by-step installer: sign in with GitHub, creates accounts, provisions Cloudflare resources, and generates your secrets in one flow.
